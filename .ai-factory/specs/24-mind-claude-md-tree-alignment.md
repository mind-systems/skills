...
1. `~/projects/skills/docs/philosophy/context-tree.md` — the tree model: trunk/crown/roots, input-to-leaf raising, links as edges.
2. `~/projects/skills/docs/philosophy/skill-pyramid.md` — tiny authoritative top, expanding depth, authority by reading order.
3. `~/projects/skills/docs/philosophy/skill-composition-model.md` — one home per fact's deeper ground: duplication drifts; what to pin vs. what to trust.
